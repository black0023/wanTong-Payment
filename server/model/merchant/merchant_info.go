...
type MerchantInfo struct {
 global.GVA_MODEL 
      MchNo  string `json:"mch_no" form:"mch_no" gorm:"primarykey;column:mch_no;comment:商户号;size:20;" binding:"required"`  //商户号 
      MchAcc  string `json:"mch_acc" form:"mch_acc" gorm:"column:mach_acc;comment:商户账号;size:50;" binding:"required"`  //商户账号 
      Password  string `json:"password" form:"password" gorm:"column:password;comment:密码;size:128;"`  //密码 
      ...
      Enable  *bool `json:"enable" form:"enable" gorm:"default:True;column:enable;comment:启用;"`  //启用 
