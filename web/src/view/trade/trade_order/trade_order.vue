  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
          <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateTradeOrderFunc(scope.row)">
              变更
            </el-button>
    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
      ...
      <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="商户名:" prop="mch_name">
          <el-input v-model="formData.mch_name" :clearable="true" placeholder="请输入商户名"/>
        </el-form-item>
        <el-form-item label="平台订单号:" prop="platform_order">
        ...
        <el-form-item label="成功时间:" prop="success_time">
          <el-date-picker v-model="formData.success_time" type="date" style="width:100%" placeholder="选择日期"
                          :clearable="true"/>
        </el-form-item>
        <el-form-item label="回调时间:" prop="callback_time">
          <el-date-picker v-model="formData.callback_time" type="date" style="width:100%" placeholder="选择日期"
                          :clearable="true"/>
        </el-form-item>
